...
% Short title
\shorttitle{Calibration Hazards in Multimodal Fusion for ccRCC}

% Main title
\title [mode = title]{Calibration Hazards and Evaluation Artifacts in Decision-Level Multimodal Fusion for Metastasis Prediction in Clear Cell Renal Cell Carcinoma}
