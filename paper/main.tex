...
% Short title
\shorttitle{Calibration Hazards in Multimodal Decision Fusion for ccRCC}

% Main title
\title [mode = title]{Calibration Hazards and Evaluation Artifacts in Decision-Level Multimodal Fusion for Renal Cell Carcinoma Metastasis Prediction}
