...
\subsection{Base Model Performance (Out-of-Fold, $n = 126$)}
...
\subsection{Calibration and Multimodal Fusion Performance}
...
\subsection{Clinical Utility, SHAP, and Statistical Comparison}
...
\subsection{Secondary Cohort Generalization, Sensitivity, and Resubstitution Reconciliation}
